...
public class FastBreak extends Check implements BlockBreakCheck {
    ...
    ImmutableVector3i targetBlockPosition = null;
    ...
    public void onPacketReceive(PacketReceiveEvent event) {
        ...
        if ((player.getClientVersion().isNewerThanOrEquals(PacketClientVersions.V_1_9) ? event.getPacketType() == PacketTypes.Play.Client.ANIMATION : isFlying(event.getPacketType())) && targetBlockPosition != null) {
