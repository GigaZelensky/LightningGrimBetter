package ac.grim.boar.anticheat.packets.input;

import ac.grim.boar.anticheat.GlobalSetting;
import ac.grim.boar.anticheat.data.input.TickData;
import ac.grim.boar.anticheat.data.input.VelocityData;
import ac.grim.boar.anticheat.packets.input.legacy.LegacyAuthInputPackets;
import ac.grim.boar.anticheat.player.BoarPlayer;
import ac.grim.boar.anticheat.prediction.PredictionRunner;
import ac.grim.boar.anticheat.teleport.data.TeleportCache;
