package ac.grim.boar.anticheat.player;

import ac.grim.boar.anticheat.compensated.cache.entity.EntityCache;
import ac.grim.boar.anticheat.compensated.world.CompensatedWorldImpl;
import ac.grim.boar.anticheat.data.UseItemCache;
import ac.grim.boar.anticheat.data.block.BoarBlockState;
import ac.grim.boar.anticheat.data.vanilla.AttributeInstance;
import ac.grim.boar.anticheat.teleport.TeleportUtil;
import ac.grim.boar.anticheat.util.MathUtil;
import ac.grim.boar.anticheat.util.math.Vec3;
import ac.grim.boar.geyser.util.GeyserUtil;
import ac.grim.boar.protocol.mitm.CloudburstReceiveListener;
import lombok.Getter;

import ac.grim.boar.anticheat.check.api.holder.CheckHolder;
import ac.grim.boar.anticheat.compensated.CompensatedInventory;
import ac.grim.boar.anticheat.data.FluidState;
import ac.grim.boar.anticheat.validator.BreakingBlockValidator;
import ac.grim.boar.anticheat.util.math.Box;
import ac.grim.boar.anticheat.util.math.Mutable;
import ac.grim.boar.anticheat.validator.ItemTransactionValidator;
import ac.grim.boar.protocol.mitm.CloudburstSendListener;
import ac.grim.boar.anticheat.player.data.PlayerData;
import ac.grim.boar.anticheat.util.ChatUtil;
